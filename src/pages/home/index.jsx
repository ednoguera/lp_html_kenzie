...
const Home = () => {
    ...
    const textSubTitle = (
        <p>
            <strong style={{ color: blue }}>Aprenda HTML e CSS do zero</strong>{" "}
    ...
    const subT2 = (
        <p>
            <strong style={{ color: orange }}>100% GRÁTIS</strong> E AO VIVO
        </p>
    );
    ...
    const textPreFooterTitle = (
        <p>
            ...
            para você dar um start em sua carreira dev e ser uma pessoa
            programadora de sucesso,{" "}
            <strong style={{ color: blue }}>disputada pelo mercado</strong>, na
            área de programação.
        </p>
    );
    ...
    const Label = (
        <p>
            Inscrição gratuita<strong style={{ color: orange }}>!</strong>
        </p>
    );
